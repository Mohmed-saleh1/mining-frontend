...
export default function ManagerLayout({
  ...
  const navItems = [
    { name: t('dashboard'), href: "/manager", icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" },
    { name: t('receivingAddresses'), href: "/manager/receiving-addresses", icon: "M17 9V7a5 5 0 00-10 0v2M5 9h14l1 10H4L5 9zm7 4v2" },
    { name: t('users'), href: "/manager/users", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
    { name: t('reports'), href: "/manager/reports", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
  ];
        ...
        <div className="p-6 border-b border-border">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gold">{t('managerPanel')}</p>
            </div>
          </Link>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-border">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gold truncate">{t('manager')}</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between px-4 h-16">
          <Link href="/" className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="text-xs text-gold ml-1">{t('managerPanel')}</span>
            </div>
          </Link>
