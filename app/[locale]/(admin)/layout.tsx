...
export default function AdminLayout({
  ...
  const navItems = [
    ...
    { name: t('withdrawals'), href: "/admin/withdrawals", icon: "M12 8c-1.657 0-3 .895-3 2v7a3 3 0 006 0v-7c0-1.105-1.343-2-3-2zm0-4a2 2 0 00-2 2v1h4V6a2 2 0 00-2-2zm-7 9h3m8 0h3M7 21h10" },
