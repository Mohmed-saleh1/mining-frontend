        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-4">
                ...
                >
                  ...
                  <div className="text-left hidden lg:block">
                    ...
                    <p className="text-xs text-foreground-muted">
                      {!user.emailVerified && (
                        <span className="text-gold">Verify email</span>
                      )}
                      {user.emailVerified && (
            ...
            <div className="flex items-center gap-2 ml-2">
              <button className="w-8 h-8 rounded-full bg-background-card border border-border flex items-center justify-center hover:border-gold transition-colors">
